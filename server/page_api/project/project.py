...
from ml.prediction_from_model import Generate_predictions_using_trained_model
...
def get_results():
    ...
    file_path = Generate_predictions_using_trained_model(trained_model.trained_model_path, input_file.file_path, project_id)
    ...
    actual_data_columns = [actual_csv.columns[0], actual_csv.columns[1]]
    actual_data_df = df[actual_data_columns]
    new_column_names = {actual_csv.columns[0]: 'x', actual_csv.columns[1]: 'y'}
